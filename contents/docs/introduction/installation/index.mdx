---
title: Installatios
description: This guide covers the installations of Documents and how to edit your new project.
keywords: ["installation", "github", "node", "guide", "nextjs", "documents"]
---

Bla bla To install and edit the Documents, you need to have several prerequisites in place. Here's a list of all the essential pre-requisites 
